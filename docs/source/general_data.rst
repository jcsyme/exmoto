...
EXMOTO allows users to create sectors and subsectors. Each subsector must belong to a sector. If using EXMOTO without sectoral interactions, then the user should define a single sector and subsector.

.. csv-table:: Example Sector
